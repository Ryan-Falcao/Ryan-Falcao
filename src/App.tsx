...
const projetos = [
  ...
  {
    title: "Descubra seu Stand",
    desc: "Site consumindo API-Rest propria. Coloque sua data de nascimento e descubra qual seria seu Stand na parte 3 de JoJo.",
    tags: ["Java", "Spring boot", "React", "JavaScript"],
    link: "https://descubra-seu-stand-frontend.vercel.app/",
    highlight: true,
  },
];
    ...
    <section className="section section-alt" id="contato">
      <div className="container contact-container">
        ...
        <div className="social-links">
          ...
          <span>·</span>
          <a href="mailto:ryanmarques2007f@gmail.com">Email</a>
        </div>
      </div>
    </section>
  );
