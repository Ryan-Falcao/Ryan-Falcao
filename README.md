...
<img src="https://capsule-render.vercel.app/api?type=waving&color=0:8d52ff,100:6DB33F&height=250&section=header&text=Ryan%20Falcão&fontSize=60&fontColor=ffffff&animation=fadeIn&fontAlignY=35&desc=Desenvolvedor%20Backend%20Java%20%7C%20Spring%20Boot&descAlignY=55&descSize=20" width="100%" />

<a href="https://linkedin.com/in/ryan-falcão">
  <img src="https://img.shields.io/badge/LinkedIn-0077B5?style=for-the-badge&logo=linkedin&logoColor=white" />
</a>
<a href="mailto:ryanmarques2007f@gmail.com">
...
```mermaid
graph LR
    A[Java Core<br/>OOP · Collections · Streams] --> B[Spring Boot<br/>REST APIs]
    B --> C[Spring Security<br/>JWT ⚡ foco atual]
    C --> D[Spring Data JPA<br/>Hibernate]
    D --> E[Testes<br/>JUnit]
```
